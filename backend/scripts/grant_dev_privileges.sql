...
REVOKE UPDATE, DELETE, TRUNCATE ON TABLE clinical_observation_write_idempotency FROM app_dml;
...
GRANT INSERT, SELECT ON TABLE clinical_observation_write_idempotency TO app_dml;
