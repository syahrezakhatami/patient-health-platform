...
class MedicationModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "medications"
    __table_args__ = (
        Index("ix_medications_patient_identity_id", "patient_identity_id"),
        Index("ix_medications_encounter_id", "encounter_id"),
        Index("ix_medications_organization_id", "organization_id"),
        Index("ix_medications_recorded_at", "recorded_at"),
    )
    ...
    code_display: Mapped[str | None] = mapped_column(String(255), nullable=True)
    status: Mapped[str] = mapped_column(String(32), nullable=False)
    dose_numeric: Mapped[Decimal | None] = mapped_column(Numeric(14, 4), nullable=True)
...
class AllergyModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "allergies"
    __table_args__ = (
        Index("ix_allergies_patient_identity_id", "patient_identity_id"),
        Index("ix_allergies_encounter_id", "encounter_id"),
        Index("ix_allergies_organization_id", "organization_id"),
        Index("ix_allergies_recorded_at", "recorded_at"),
    )
    ...
    reaction_code_system: Mapped[str | None] = mapped_column(String(128), nullable=True)
    reaction_code: Mapped[str | None] = mapped_column(String(64), nullable=True)
    reaction_display: Mapped[str | None] = mapped_column(String(255), nullable=True)
    onset_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    recorded_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    recorder_id: Mapped[UUID | None] = mapped_column(PGUUID(as_uuid=True), nullable=True)
    version: Mapped[int] = mapped_column(Integer, nullable=False)
...
class ImmunizationModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "immunizations"
    __table_args__ = (
        Index("ix_immunizations_patient_identity_id", "patient_identity_id"),
        Index("ix_immunizations_encounter_id", "encounter_id"),
        Index("ix_immunizations_organization_id", "organization_id"),
        Index("ix_immunizations_recorded_at", "recorded_at"),
    )
...
class ProcedureModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "procedures"
    __table_args__ = (
        Index("ix_procedures_patient_identity_id", "patient_identity_id"),
        Index("ix_procedures_encounter_id", "encounter_id"),
        Index("ix_procedures_organization_id", "organization_id"),
        Index("ix_procedures_recorded_at", "recorded_at"),
    )
...
class MedicalDeviceModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "medical_devices"
    __table_args__ = (
        Index("ix_medical_devices_patient_identity_id", "patient_identity_id"),
        Index("ix_medical_devices_encounter_id", "encounter_id"),
        Index("ix_medical_devices_organization_id", "organization_id"),
        Index("ix_medical_devices_recorded_at", "recorded_at"),
    )
...
class AdverseEventModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "adverse_events"
    __table_args__ = (
        Index("ix_adverse_events_patient_identity_id", "patient_identity_id"),
        Index("ix_adverse_events_encounter_id", "encounter_id"),
        Index("ix_adverse_events_organization_id", "organization_id"),
        Index("ix_adverse_events_recorded_at", "recorded_at"),
    )
    ...
    medical_device_id: Mapped[UUID | None] = mapped_column(
        PGUUID(as_uuid=True),
        ForeignKey("medical_devices.id", ondelete="RESTRICT"),
        nullable=True,
    )
...
class FamilyHistoryModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "family_histories"
    __table_args__ = (
        Index("ix_family_histories_patient_identity_id", "patient_identity_id"),
        Index("ix_family_histories_encounter_id", "encounter_id"),
        Index("ix_family_histories_organization_id", "organization_id"),
        Index("ix_family_histories_recorded_at", "recorded_at"),
    )
