...
class FamilyHistoryRelationship(StrEnum):
    PARENT = "PARENT"
    SIBLING = "SIBLING"
    CHILD = "CHILD"
...
class FamilyHistoryCategory(StrEnum):
    DOCUMENTED = "DOCUMENTED"
    REPORTED = "REPORTED"
...
class ClinicalAuditAction(StrEnum):
    ...
    FAMILY_HISTORY_CREATED = "FAMILY_HISTORY_CREATED"
    FAMILY_HISTORY_AMENDED = "FAMILY_HISTORY_AMENDED"
    FAMILY_HISTORY_ENTERED_IN_ERROR = "FAMILY_HISTORY_ENTERED_IN_ERROR"
